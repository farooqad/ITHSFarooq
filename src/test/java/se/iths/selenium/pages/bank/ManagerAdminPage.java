...
public class ManagerAdminPage {
    ...
    By openAccountButton = By.xpath("/html/body/div[3]/div/div[2]/div/div[1]/button[2]");
    By selectCustomerName = By.xpath("//*[@id=\"userSelect\"]/option[7]");
    By selectCurrency = By.xpath("//*[@id=\"currency\"]/option[2]");
    By processButton = By.xpath("/html/body/div[3]/div/div[2]/div/div[2]/div/div/form/button");
    ...
    public void openAcount(){
        ...
        driver.findElement(selectCustomerName);
        driver.findElement(selectCurrency);
