...
public class CucumberUser {
    ...
    public void validate_the_username_if_changes_has_been_made(String username) {
        ...
        new UserPetStoreClient().getUser("Furkan", 200);
    }


    @When("i delete the user with username furkan")
    public void iDeleteTheUserWithUsernameFurkan() {

        new UserPetStoreClient().deleteUser("Furkan");
    }
}
