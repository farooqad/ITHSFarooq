...
public class SelenideTest {
    ...
    public void myFirstSelenideTest(){
        ...
        $(By.xpath("/html/body/div[3]/div/div[2]/div/div[1]/div[1]/button")).click();
        $(By.xpath("//*[@id=\"userSelect\"]/option[3]"));
        $(By.xpath("/html/body/div[3]/div/div[2]/div/form/button")).click();
